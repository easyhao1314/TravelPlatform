		...
		<table id="dg" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th data-options="field:''" width="80">景点编号</th>
					<th data-options="field:''" width="80">所属城市</th>
					<th data-options="field:''" width="80">景点名称</th>
					<th data-options="field:''" width="80">景点英文名称</th>
					<th data-options="field:''" width="80">门票价格</th>
					<th data-options="field:''" width="80">币种</th>
					<th data-options="field:''" width="80">是否订车默认景点</th>
