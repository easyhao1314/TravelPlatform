...
<script type="text/javascript" src="js/jquery.easyui.min.js"></script>
	...
	<body>
		...
		<div id="myPrintArea" align="left">
			<font style="margin-left: 28px;">GF--2010--2401</font><br />
			<div align="center"><h3>团队出境旅游合同</h3></div><br />
			<div align="center">国家旅游局制定、国家工商行政管理总局</div>
            <div align="center">使　用　说　明</div>
 ...
 <div id="divdiyizhangleft" style="width: 50%; font-size: 12px; float: left; " align="left">
 ...
 <div id="divdiyizhangright" style="width: 50%; font-size: 12px; float: left; "  align="left">
 ...
 <div id="divdierzhangleft" style="width: 50%; font-size: 12px; float: right; " align="left">
  ...
  <div id="divdierzhangright" style="width: 50%; font-size: 12px;  " align="left">
...
提前告知时间	旅游者行前退团应当支付出境社的业务损失费占旅游费用总额的百分比	出境社取消出团应当支付旅游者的违约金占旅游费用总额的百分比
出发前    日至    日		
出发前    日至    日		
出发前    日至    日		
出发前    日至    日		
