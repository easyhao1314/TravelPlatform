...
<div class="easyui-panel" title="客户价值字典查询"
    ...
    <!-- 查询结果展示 -->
	  ...
	  <div class="easyui-panel" title="客户价值字典列表"
		...
		<table id="dg" class="easyui-datagrid"
			data-options="url:'fenghuang/KehuSelect.do?type=3',border:false,singleSelect:true,fit:true,fitColumns:true,pageSize:20"
	...
	<!-- 新增客户资信字典 -->
	<div id="addZiXin" class="easyui-dialog" title="新增客户价值字典"
	...
	<!-- 新增客户资信字典结束 -->
		...
		<!-- 修改客户资信字典 -->
	<div id="updateZiXin" class="easyui-dialog" title="修改客户价值字典"
		data-options="modal:true,closed:true,iconCls:'icon-save'"
		style="width:600px;height:200px;padding:10px;">
 ...
 */
	   ...
	   //新增
		...
		function SaveZiXin() {
			$('#addForm').form('submit', {
				url : 'fenghuang/KehuAdd.do?type=3',
				onSubmit : function() {
	...
	function shanchu(){
	  var row = $("#dg").datagrid("getSelected");
			if (row) {
				...
				if(confirm("确认要删除名称为 “ "+row.name+" ”的客户价值字典吗？")){
				$.ajax({
