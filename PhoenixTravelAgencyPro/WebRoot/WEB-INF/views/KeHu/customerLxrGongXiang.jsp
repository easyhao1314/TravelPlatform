...
<body>
	<div class="easyui-panel" title="联系人共享/转移"
        ...
        <form id="ff" method="post"> 
            ...
            <tr>
               ...
               <a href="javascript:kehuSelectLike();" 
								class="easyui-linkbutton" iconCls="icon-ok">查询联系人</a>
    ...
    <!-- 查询结果展示 -->
		<div class="easyui-panel" title="联系人共享/转移" style="height:480px;width: auto;">
