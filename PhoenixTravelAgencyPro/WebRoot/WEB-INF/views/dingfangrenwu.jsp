...
<body>
    ...
    <div class="easyui-panel" title="分类查询" style="width:900px">  
        ...
        <form id="ff" method="post"> 
            ...
            <tr>
               <td>派单:</td>  
               <td>从：<input class="easyui-datebox" name="paidanStartTime" size="13"/>&nbsp;  
               <td>到：</td>
               <td><input class="easyui-datebox" name="paidanEndTime" size="13" />  </td>  
               <td>出团:</td>  
               <td>从：<input class="easyui-datebox" name="chutuanStartTime" size="13"/>&nbsp;  
               <td>到：</td>
               <td><input class="easyui-datebox" name="chutuanEndTime" size="13" />  </td>  
               <td>关键字:</td>  
