...
<table id="dg" class="easyui-datagrid"
		data-options="url:'fenghuang/customInfoList.do?type=33&tuanNo=${param.tuanNo}',singleSelect:true,fitColumns:true,pageSize:10"
		pagination="true">
		<thead>
			<tr>
...
return sexinfo;
				...
				<th data-options="field:'sfzn'" width="80">证件号</th>
