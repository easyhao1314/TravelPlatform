...
<body>
		...
		style="width:300px;height:180px;padding:10px;">
                    <table>
	    		    <tr>
	    		   	<td>销售:<input class="easyui-validatebox" type="text" name="team"  id="team" style="width:200px"></input></td>
	    		   	</tr>
	    		   	<tr>
	...
	<table id="sanpindg" class="easyui-datagrid"
		data-options="url:'fenghuang/tongjizhongxinsanpinselect.do',border:false,singleSelect:true,fit:true,fitColumns:true,pageSize:20"
		...
		<thead>
			<tr>
				...
				<th data-options="field:'renshu',formatter:aaaa" width="50" >人头数</th>
			</tr>	
