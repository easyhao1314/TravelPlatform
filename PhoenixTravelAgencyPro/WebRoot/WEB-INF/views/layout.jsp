	...
	<div data-options="region:'west',split:true" title="菜单"
		...
		<ul class="easyui-tree">
			...
			<li iconCls="icon-base"><span>操作中心</span>
				<ul>
					<li iconCls="icon-gears"><a
						href="javascript:open1('操作团队查询','operateCenterUI.do');">操作团队查询</a></li>
				</ul>
				<ul>
					<li iconCls="icon-gears"><a
						href="javascript:open1('我派的酒店订房任务','dingfangrenwu.do');">我派的订房任务</a></li>
				</ul>
			</li>
			...
			<li iconCls="icon-base"><span>客户中心</span>
				<ul>
					<li iconCls="icon-gears"><a
						href="javascript:open1('客户信息列表','customerInfoList.do');">客户信息列表</a></li>
				</ul>
				<ul>
					<li iconCls="icon-gears"><a
						href="javascript:open1('联系人信息列表','contactInfoList.do');">联系人信息列表</a></li>
				</ul>
				<ul>
					<li iconCls="icon-gears"><a
						href="javascript:open1('客户VIP字典','customerVIPDic.do');">客户VIP字典</a></li>
				</ul>
			</li>
		</ul>
	</div>
