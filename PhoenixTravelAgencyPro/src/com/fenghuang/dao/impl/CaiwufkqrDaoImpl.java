...
public class CaiwufkqrDaoImpl extends BaseDao implements IcaiwufkqrDao {
	...
	public Pagination<Tuanbiao> getPaginationfkqr(int currentPage,
		...
		// TODO Auto-generated method stub
		StringBuffer sql=new StringBuffer("SELECT ss.userName,t.id,t.payment,t.team,t.suppliers,t.caiwuid,t.zhanghaoid,t.shenfenid,t.chutuantime,t.huituantime,t.yingshou,t.yishou,t.yifu,t.tuikuan,t.fanyong,t.yujilirun,t.shijilirun,t.danhao,t.fukuantime,t.yushoutime,t.huilvID,t.ykfp,t.fpxk,t.fuzeren,t.zhuangtai,t.ysyfID,t.khmc,t.kxsm,t.renshu,t.ddje,t.fankuan,t.yajin,t.cgje,t.cglr,t.zhichu,t.maoli,t.maolilv,t.beizhu,t.yfk,t.baojia,t.chengben,t.shanchu,t.tuanduimc,f.status,f.review,f.confirmed,f.cashier,b.bizhong,b.riqi,b.xianjinhuilv,b.gongshou,b.zhonghang,b.zuidihuilv,b.huilv,b.jianxie,b.jianxiemingchen,b.danwei FROM tuanbiao AS t INNER JOIN finance AS f on t.caiwuid=f.id INNER JOIN bizhonghuilv AS b on t.huilvID=b.id LEFT JOIN users AS ss ON ss.id=t.caozuo   where t.shanchu=1 ");
