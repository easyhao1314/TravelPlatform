...
public class ZyJingdianDaoImpl extends BaseDao implements IZyJingdianDao{
	...
	public Pagination<Jingdian> jingdianSelect(int currentPage, int numPerPage,String name,String chengsiId,String jiage)
		...
		StringBuffer sql=new StringBuffer("select j.id,j.name,j.name2,d.dicName as chengsi,j.jiage,d1.dicName as bizong,d2.dicName as sf from jingdian  as j left join  dictionarydesc as d on j.chengsiId=d.dicNo left join dictionarydesc as d1 on j.bizongId=d1.dicNo left join dictionarydesc as d2 on j.dcmr=d2.dicNo where 1=1 ");
